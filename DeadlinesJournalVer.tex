...
\end{lemma}
\begin{proof}
By induction over the depth of $\tau$ denoted by $d$. It is easy to see, by looking at the definition of $err$ that the degree is increased by one if and only if the root of a subtree is a parallel node. 
