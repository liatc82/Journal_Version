...
{\em linear plans}~\cite{Russell:2003:AIM:773294,simmons2001planning}.%, aktolga2004java}. %TODO: add this refference
...
\begin{proof} 
First proved \hl{in}~\cite{---} and also shown in~\cite{cohen2015estimating}, by reduction from \textit{SubsetSum}~\cite[problem number SP13]{Garey:1990:CIG:574848}.
%Recall that
