...
\hl{Another option is, when given a specific threshold, trying for higher accuracy in just the region of the
threshold, but how to do that is non-trivial.}
%TODO: add more info about the new Trim algo - split distribution to equal to epsilon
For {\em sampling} schemes such methods are known, including adaptive 
