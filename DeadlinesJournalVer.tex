...
\end{lemma}
\begin{proof}
By induction over the depth of $\tau$. By the definition of $err$, its degree is one more than that of the maximal among the children of $r$ if and only if the root of the tree is a parallel node. 
\end{proof}
