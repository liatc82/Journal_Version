...
%To prove that the problem is in \#P we need to show that 

%there exists a language in NP with a non-deterministic Turing Machine whose number of accepting paths is the number of satisfying assignments (this is one of the definitions of the class \#P)
	
%Next we define an NP problem for which counting possible witness is equivalent (by scaling) to computing the probability of missing a deadline in the deadline problem.
