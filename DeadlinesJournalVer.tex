...
\begin{theorem}\label{theorem:approxEps0}
	For a task tree $\tau$ rooted at $r$ and a function $\varepsilon$ that maps the sequence nodes in $\tau$ to numbers in $[0,1]$, let $X_{\tau}$ be the random variable for the true
